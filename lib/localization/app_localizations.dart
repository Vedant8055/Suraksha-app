...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'password': 'Password',
      'login': 'LOGIN',
      'loginConnecting': 'Signing in… server may take up to 2 min if idle',
    ...
    'hi': {
      ...
      'password': 'पासवर्ड',
      'login': 'लॉगिन',
      'loginConnecting': 'साइन इन हो रहा है… सर्वर idle हो तो ~2 मिनट लग सकते हैं',
    ...
    'mr': {
      ...
      'password': 'पासवर्ड',
      'login': 'लॉगिन',
      'loginConnecting': 'साइन इन होत आहे… सर्व्हर idle असेल तर ~2 मिनिट लागू शकतात',
