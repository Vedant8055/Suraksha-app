                  ...
                  if (statusText != null) ...[
                    ...
                    Text(
                      AppLocalizations.of(context)
                          .localizeStatusMessage(statusText),
                  ...
                  if (contributingFactors.isNotEmpty) ...[
                    ...
                    ...contributingFactors.take(4).map(
                      (factor) => Padding(
                        ...
                        child: Text(
                          '• ${AppLocalizations.of(context).localizeDynamic(factor)}',
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 12.5,
                            fontWeight: FontWeight.w600,
                  ...
                  if (recommendations.isNotEmpty) ...[
                    ...
                    ...recommendations.take(4).map(
                      (item) => Padding(
                        padding: const EdgeInsets.only(bottom: 6),
                        child: Text(
                          '• ${AppLocalizations.of(context).localizeDynamic(item)}',
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 12.5,
                            fontWeight: FontWeight.w600,
